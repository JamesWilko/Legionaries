...
if modifier_sell_unit_fire_think == nil then
	modifier_sell_unit_fire_think = class({})
end

function modifier_sell_unit_fire_think:IsHidden()
	return true
end
...
function modifier_sell_unit_fire_think:OnIntervalThink()
	if IsServer() then
