...
if modifier_sell_unit_mech_think == nil then
	modifier_sell_unit_mech_think = class({})
end

function modifier_sell_unit_mech_think:IsHidden()
	return true
end

function modifier_sell_unit_mech_think:OnCreated( kv )
...
function modifier_sell_unit_mech_think:OnIntervalThink()
	if IsServer() then
