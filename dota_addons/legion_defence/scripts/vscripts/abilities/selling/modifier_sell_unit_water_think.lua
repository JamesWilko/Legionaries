...
if modifier_sell_unit_water_think == nil then
	modifier_sell_unit_water_think = class({})
end

function modifier_sell_unit_water_think:IsHidden()
	return true
end

function modifier_sell_unit_water_think:OnCreated( kv )
...
function modifier_sell_unit_water_think:OnIntervalThink()
	if IsServer() then
