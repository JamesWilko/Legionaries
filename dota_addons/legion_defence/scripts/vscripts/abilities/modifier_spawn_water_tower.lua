...
if modifier_spawn_water_tower == nil then
	modifier_spawn_water_tower = class({})
end

function modifier_spawn_water_tower:IsHidden()
	return true
end

function modifier_spawn_water_tower:OnCreated( kv )
...
function modifier_spawn_water_tower:OnIntervalThink()
	if IsServer() then
