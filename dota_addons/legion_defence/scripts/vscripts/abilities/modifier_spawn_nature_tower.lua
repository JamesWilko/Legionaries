...
if modifier_spawn_nature_tower == nil then
	modifier_spawn_nature_tower = class({})
end

function modifier_spawn_nature_tower:IsHidden()
	return true
end

function modifier_spawn_nature_tower:OnCreated( kv )
...
function modifier_spawn_nature_tower:OnIntervalThink()
	if IsServer() then
